    ...
    for blocklen in np.unique(blocklens):
        for coderate in np.unique(coderates):
            ...
            for mod_type in np.unique(mod_types):
                ...
                ax.semilogy(snrs, awgn_bers,  linewidth=2, marker='o',
                            markersize=marker + 2)
                ax.semilogy(snrs, ray_bers,  linewidth=2, marker='o', markersize=marker)
                ax.semilogy(snrs, rici_bers,  linewidth=2, marker='o',
                            markersize=marker + 2)
