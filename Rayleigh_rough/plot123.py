...
if __name__ == '__main__':
    ...
    # channels = chan.SISOFlatChannel(None, (0j,1 + 0j))
    # channels = chan.SISOFlatChannel(None, (0,1))
    ...
    # plt.plot(channels.noises)
    # plt.grid()
    # plt.legend('noises')
    # plt.show()
    # plt.plot(channels.unnoisy_output)
    # plt.grid()
    # plt.legend('unnoisy_output')
    # plt.show()
    # plt.plot(channels.unnoisy_output+channels.noises)
    # plt.grid()
    # plt.legend('unnoisy_output + noises')
    # plt.show()
    # print(SNRs)
    # print(mean_BER_theoretical)
    # plt.semilogy(SNRs, BERs_hard, 'o-', SNRs, BERs_soft, 'o-',SNRs,mean_BER_theoretical,'o-')
    # plt.grid()
    # plt.xlabel('Signal to Noise Ration (dB)')
    # plt.ylabel('Bit Error Rate')
    # plt.legend(('Hard demodulation', 'Soft demodulation','Theoritical Modulation'))
    # plt.show()
    # Test
    BERs_hard = model_hard.link_performance(SNRs, 10000, 600, 5000, code_rate)
    BERs_soft = model_soft.link_performance(SNRs, 10000, 600, 5000, code_rate)
